...
hDrawLine += 4;
draw_text(hDrawLine,vDrawLine,string(global.countAdultBunnies));
...
hDrawLine += 4;
draw_text(hDrawLine,vDrawLine,string(global.countBunnyWells));
...
hDrawLine += 4;
draw_text(hDrawLine,vDrawLine,string(global.countBunnyTrees) + "/" + string(global.countBunnyTimber));
...
hDrawLine += 4;
draw_text(hDrawLine,vDrawLine,string(global.countAdultGreens));
...
switch (oPlayer1.buildIndex)
{
  case oPlayer1.SETTLEMENT:  
    draw_sprite(sHudCarrots,0,hDrawLine,vDrawLine);  
    hDrawLine -= 4;         
    draw_text(hDrawLine,vDrawLine,string(global.SETTLEMENT_COST));
  ...
  case oPlayer1.TURRET:
    draw_sprite(sHudCarrots,0,hDrawLine,vDrawLine);  
    hDrawLine -= 4;         
    draw_text(hDrawLine,vDrawLine,string(global.TURRET_COST));
  ...
  case oPlayer1.WHITE_FENCE:
    draw_sprite(sHudCarrots,0,hDrawLine,vDrawLine);  
    hDrawLine -= 4;         
    draw_text(hDrawLine,vDrawLine,string(global.FENCE_COST));
...
hDrawLine -= 4;
draw_text(hDrawLine,vDrawLine,"Bld");  
