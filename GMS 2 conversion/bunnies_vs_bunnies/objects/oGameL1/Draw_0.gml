...
*/
draw_text(1180,450,string_hash_to_newline("Continue to build burrows until your population reaches 20 adult rabbits.##Remember: the brown bunnies are breeding."));
