...
//Level text
draw_text(110,430,string_hash_to_newline("This is your first burrow.#Right now you can't have any bunny babies,#because you have no water supply."))
draw_text(480,130,string_hash_to_newline("Each watering hole can support 5 bunnies.#Build a burrow on the left side of this platform by pressing X on your keyboard.#You cannot build directly on top of the water."))
draw_text(930,250,string_hash_to_newline("In the upper left corner you can see your carrot supply has shrunk.#It takes 100 carrot resources to make a burrow.#Make another burrow on this platform with the giant carrot,#then check your supply again. The more giant carrots you have,#the faster your carrot resource supply will grow."))
/*
...
*/
draw_text(1140,430,string_hash_to_newline("Continue to build burrows until your population reaches 20 adult rabbits.#Remember: those other bunnies are breeding."));
draw_text(1460,90,string_hash_to_newline("A burrow's reach is limited. Choose locations wisely to claim multiple resources."))
